...
def main():
    ...
    for i, test_case in enumerate(sample, 1):
        ...
        case_number = input_dict.get('CASE_NUMBER') or input_dict.get('LCA_CASE_NUMBER') or input_dict.get('CASE_NO', '')
        employer_name = input_dict.get('EMPLOYER_NAME') or input_dict.get('LCA_CASE_EMPLOYER_NAME') or input_dict.get('NAME', '')
        wage_from = input_dict.get('WAGE_RATE_OF_PAY_FROM') or input_dict.get('LCA_CASE_WAGE_RATE_FROM') or input_dict.get('WAGE_RATE_1', '')
        ...
        if result is None:
            ...
            print(f"  This is a test failure - annotation is wrong!")
