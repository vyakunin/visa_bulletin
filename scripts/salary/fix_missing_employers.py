...
def get_or_create_employer(employer_name: str, city: str | None, state: str | None) -> Employer:
...
def fix_missing_employers(dry_run: bool = True, limit: int | None = None) -> dict:
    ...
    logger.info(f"{mode_str}Fixed {fixed_count:,} records, created {created_count} employers")
