...
MANUAL_DECISIONS = [
    # Same company cases
    ('Governmental Management Services', 'Governmental Management Services', 'approved', 'Missing hyphen in normalization'),
    ('RAISON PURE INTERNATIONAL', 'Raison Pure Internatial', 'approved', 'Typo: Internatial vs International'),
    ('Sunpower Corporation', 'Sunpower Corporations', 'approved', 'Punctuation/plural variation'),
    ('SaarGummi Tennessee', 'SAARGUMMI TENNESSEE', 'approved', 'Typo: lnc vs inc, same company'),
    ('New England Annual Conference', 'New England Conference', 'approved', 'Missing "Annual" word'),
    ('Edward C. Donahue, C.P.A.', 'Edward C. Donahue, CPA', 'approved', 'C.P.A. vs CPA variation'),
    ('Penn Schoen & Berland', 'Penn, Schoen and Berland', 'approved', 'Punctuation variation'),
    ('Padilla', 'PADILLA AND COMPANY', 'approved', 'Spacing/and variation'),
    ('ORTHOPAEDIC ASSOCIATES', 'ORTHOPAEDIC ASSOCIATES LLP', 'approved', 'Missing LLP suffix'),
    ...
    ('GREENTREE CLEANERS', 'ENTREE CLEANERS', 'rejected', 'Different companies: Greentree vs Entree'),
    ...
    ('ORIC Pharmaceuticals', 'RA Pharmaceuticals', 'rejected', 'Different companies: ORIC vs RA'),
    ('B Properties', 'LBTS PROPERTIES', 'rejected', 'Different companies: B vs LBTS'),
    ('David Yurman', 'David Ryuman', 'rejected', 'Different companies: Yurman vs Ryuman'),
    ('ISN Software', 'MSC Software', 'rejected', 'Different companies: ISN vs MSC'),
    ('Inspirit IoT', 'Inspirit AI', 'rejected', 'Different companies: IoT vs AI divisions'),
    ('Eta Wireless', 'AA WIRELESS', 'rejected', 'Different companies: Eta vs AA'),
    ('SPF North America', 'PPM North America', 'rejected', 'Different companies: SPF vs PPM'),
    ...
    ('UB TRANSPORTATION', 'LRB TRANSPORTATION', 'rejected', 'Different companies: UB vs LRB'),
    ('UB TRANSPORTATION', 'Turk Transportation', 'rejected', 'Different companies: UB vs Turk'),
    ('UB TRANSPORTATION', 'Berg Transportation', 'rejected', 'Different companies: UB vs Berg'),
    ('MARRS PROFESSIONAL', 'MMI Professional', 'rejected', 'Different companies: MARRS vs MMI'),
    ('KAPSCH TRAFFICCOM IVHS', 'KAPSCH TRAFFICCOM USA', 'rejected', 'Different divisions: IVHS vs USA'),
    ('P&S CONSTRUCTION', 'VPS Construction', 'rejected', 'Different companies: P&S vs VPS'),
    ('SMB Shared Services', 'BP&C Shared Services', 'rejected', 'Different companies: SMB vs BP&C'),
]
...
if unmatched:
    ...
    for review in unmatched[:10]:  # Show first 10
        logger.warning(f"  '{review.employer1.name}' vs '{review.employer2.name}' (sim: {review.similarity_score:.3f})")
    if len(unmatched) > 10:
