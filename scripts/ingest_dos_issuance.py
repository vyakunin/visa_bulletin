...
def process_file(filepath: Path, publication_date: date):
    ...
    with open(filepath, 'r') as f:
        ...
        for row in reader:
            ...
            if v_upper.startswith("E1"): v_cat = "1st"
            elif v_upper.startswith("E2"): v_cat = "2nd"
            elif v_upper.startswith("E3"): v_cat = "3rd"
            elif v_upper.startswith("EW"): v_cat = "3rd" # Unskilled
            elif v_upper.startswith("SR"): v_cat = "4th"
            elif v_upper.startswith("R"): v_cat = "4th"
            elif v_upper.startswith("C5") or v_upper.startswith("T5") or v_upper.startswith("I5") or v_upper.startswith("R5"): v_cat = "5th"
