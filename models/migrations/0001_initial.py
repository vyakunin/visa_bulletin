...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "city",
                    models.CharField(
                        blank=True, help_text="Employer city", max_length=100
                    ),
                ),
                (
                    "state",
                ...
                (
                    "total_perm_count",
                    models.IntegerField(default=0, help_text="Total PERM applications"),
                ),
                (
                    "avg_salary",
                    models.DecimalField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "worksite_city",
                    models.CharField(
                        blank=True, help_text="Work location city", max_length=100
                    ),
                ),
                (
                    "worksite_state",
        ...
        migrations.AddIndex(
            model_name="employer",
            index=models.Index(
                fields=["name_normalized"], name="salary_empl_name_no_6de4f1_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="employer",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="salary_reco_visa_pr_044b05_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="salaryrecord",
            index=models.Index(
                ...
                name="salary_reco_worksit_fe8724_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="salaryrecord",
            index=models.Index(
                fields=["wage_annual", "visa_program"],
                name="salary_reco_wage_an_95e1ea_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="salaryrecord",
            index=models.Index(
                fields=["decision_date"], name="salary_reco_decisio_e82d25_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="salaryrecord",
            index=models.Index(
                ...
                name="salary_reco_fiscal__f811a2_idx",
            ),
        ),
    ]
