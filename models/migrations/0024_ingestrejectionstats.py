...
class Migration(migrations.Migration):
    ...
    operations = [
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("whitelist_filtered", "Filtered by Case Number Whitelist"),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["run", "reason"], name="ingest_reje_run_id_ae4b18_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="ingestrejectionstats",
            index=models.Index(
                fields=["run", "count"], name="ingest_reje_run_id_e2c9d5_idx"
            ),
        ),
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("run", "reason"),
                name="models_ingestrejectionstats_run_id_reason_4f2b6c_uniq",
            ),
        ),
    ]
