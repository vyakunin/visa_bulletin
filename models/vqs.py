...
class PredictedCutoff(models.Model):
    ...
    """
    bulletin = models.ForeignKey(PredictedBulletin, related_name='cutoffs', on_delete=models.CASCADE)
    ...
    explanation_markdown = models.TextField(help_text="Why this prediction?", blank=True)
