...
class SupplyAllocator:
    ...
    def get_supply(
        self, visa_class: str, country: int, month: date,
        knowledge_date: date
        ...
        cascade = self.cascade.estimate_cascade_bonus(visa_class, country, month, knowledge_date)
        ...
        return MonthlySupplyAllocation(
            visa_class=visa_class, country=country, month=month,
            base_supply=base, cascade_bonus=cascade,
            fb_spillover_bonus=fb_bonus, total=final_total
        )
