...
class TestClusteringPrecision(unittest.TestCase):
    ...
    def test_structural_word_conflict_should_not_match(self):
        ...
        conflict_cases = [
            {
                'emp1': Employer(name='SERVICE MANAGEMENT GROUP, LLC', city='Kansas City', state='MO'),
                'emp2': Employer(name='CORPORATION SERVICE COMPANY', city='Wilmington', state='DE'),
                'reason': 'Management vs Corporation - different structural words'
            },
            {
                'emp1': Employer(name='TRINITY TECHNOLOGIES CORPORATION', city='Boston', state='MA'),
                'emp2': Employer(name='TRINITY PARTNERS, LLC', city='Boston', state='MA'),
                'reason': 'Technologies vs Partners - different structural words'
            },
            {
                'emp1': Employer(name='GRAHAM CAPITAL MANAGEMENT, L.P.', city='New York', state='NY'),
                'emp2': Employer(name='GRAHAM HOLDINGS COMPANY', city='New York', state='NY'),
                'reason': 'Management vs Holdings - different structural words'
            },
            {
                'emp1': Employer(name='ASPEN TECHNOLOGY, INC', city='Bedford', state='MA'),
                'emp2': Employer(name='ASPEN CONSULTING, INC.', city='Bedford', state='MA'),
    ...
    def test_location_filtering_for_generic_names_different_states(self):
        ...
        generic_cases = [
            {
                'emp1': Employer(name="CHILDREN'S HOSPITAL", city='Boston', state='MASSACHUSETTS'),
                'emp2': Employer(name="CHILDREN'S HOSPITAL", city='New Orleans', state='LOUISIANA'),
    ...
    def test_hyphen_variations_require_exact_location(self):
        ...
        hyphen_cases = [
            {
                'emp1': Employer(name='HI-TEK PROFESSIONALS, INC.', city='MEDIA', state='PENNSYLVANIA'),
                'emp2': Employer(name='HITEK PROFESSIONALS, INC.', city='MEDIA', state=''),
            ...
            {
                'emp1': Employer(name='IredellStatesville Schools', city='Statesville', state=''),
                'emp2': Employer(name='Iredell-Statesville Schools', city='Statesville', state='NC'),
            ...
            {
                'emp1': Employer(name='HI-TEK PROFESSIONALS, INC.', city='MEDIA', state='PA'),
                'emp2': Employer(name='HITEK PROFESSIONALS, INC.', city='PHILADELPHIA', state='PA'),
    ...
    def test_bbc_entities_should_cluster_appropriately(self):
        ...
        bbc_cases = [
            {
                'emp1': Employer(name='BBC International LLC', city='New York', state='NY'),
                'emp2': Employer(name='BBC International LLC', city='New York', state='NY'),
                'should_match': True,
            ...
            },
            {
                ...
                'emp2': Employer(name='BBC News USA, Inc.', city='New York', state='NY'),
                'should_match': True,
                'should_auto_cluster': True,
                'reason': 'BBC News vs BBC News USA - same news entity with USA qualifier'
            },
            {
                'emp1': Employer(name='BBC Global News US, LLC', city='New York', state='NY'),
                'emp2': Employer(name='BBC News USA, Inc.', city='New York', state='NY'),
                'should_match': True,
                'should_auto_cluster': True,
            ...
            {
                'emp1': Employer(name='BBC Innovation Corporation', city='Boston', state='MA'),
                'emp2': Employer(name='BBC News USA, Inc.', city='New York', state='NY'),
                'should_match': False,
