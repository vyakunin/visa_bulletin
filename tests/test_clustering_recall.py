...
class TestClusteringRecall(unittest.TestCase):
    ...
    def test_bucket_mismatch_cases_should_match(self):
        ...
        bucket_mismatch_cases = [
            ...
            {
                'emp1': Employer(name='APPLIED TESTESTING  GEOSCIENCES, LLC', city='BRIDGEPORT', state='PA'),
                'emp2': Employer(name='APPLIED TESTESTING & GEOSCIENCES, LLC', city='BRIDGEPORT', state='PA'),
                'should_match': True,
                'reason': 'Double space vs ampersand (bucket mismatch)'
            },
            {
                'emp1': Employer(name='Merck Sharp & Dohme Corp.', city='Kenilworth', state='NJ'),
                'emp2': Employer(name='MERCK SHARP & DOHME CORP', city='KENILWORTH', state='NEW JERSEY'),
                'should_match': True,
