...
class SalaryImportIntegrationTest(TestCase):
    ...
    def setUp(self):
        ...
        test_csv_paths = [
            ...
            Path(os.environ.get('BUILD_WORKSPACE_DIRECTORY', '')) / 'test_salary_data.csv',
        ]
    ...
    def test_import_lca_csv(self):
        ...
        google_record = SalaryRecord.objects.filter(employer_name__icontains='Google').first()
    ...
    def test_wage_calculation(self):
        ...
        for record in records:
            if record.wage_from and record.wage_unit:
                ...
                self.assertIsNotNone(calculated, f"Record {record.case_number} should have annual wage")
                self.assertEqual(record.wage_annual, calculated, 
    ...
    def test_wage_unit_parsing(self):
        ...
        for record in records:
            if record.wage_from:
                self.assertEqual(record.wage_annual, record.wage_from,
    ...
    def test_validation_rejects_low_salary(self):
        ...
        from lib.parsing.salary.wage_unit_correction import MIN_VALID_ANNUAL
    ...
    def test_validation_boundary_cases(self):
        ...
        from lib.parsing.salary.wage_unit_correction import MIN_VALID_ANNUAL, MAX_VALID_ANNUAL
