...
class TestCountryHeaderParsing(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.bulletin_files = [
            workspace_dir / 'data' / 'bulletin' / 'saved_pages' / 'visa-bulletin-for-march-2023.html',
            workspace_dir / 'data' / 'bulletin' / 'saved_pages' / 'visa-bulletin-for-february-2017.html',
            workspace_dir / 'data' / 'bulletin' / 'saved_pages' / 'visa-bulletin-for-october-2021.html',
        ]
    ...
    def test_extract_headers_from_real_bulletin_html(self):
        ...
        for file_path in self.bulletin_files:
            ...
            with self.subTest(file=file_path.name):
                ...
                self.assertGreater(len(tables), 0, f"Should find tables in {file_path.name}")
                ...
                if family_table:
                    ...
                    self.assertGreater(len(family_table.headers), 0, "Table should have headers")
                    ...
                    self.assertGreater(len(country_headers), 0, "Should have country headers")
...
class TestCountryHeaderExtractionIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        import os
        workspace_dir = Path(os.environ.get('BUILD_WORKSPACE_DIRECTORY', Path(__file__).parent.parent))
        self.bulletin_file = workspace_dir / 'data' / 'bulletin' / 'saved_pages' / 'visa-bulletin-for-february-2017.html'
    ...
    def test_extract_and_match_country_0_from_full_pipeline(self):
        ...
        with open(self.bulletin_file, 'r', encoding='utf-8') as f:
            html = f.read()
    ...
    def test_country_all_is_not_treated_as_none(self):
        ...
        self.assertEqual(
            Country.ALL.value,
            1,
            "Country.ALL.value is 1 (0 is reserved for INVALID)"
        )
