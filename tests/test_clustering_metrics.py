...
class TestClusteringMetrics(unittest.TestCase):
    ...
    def test_recall_calculation(self):
        ...
        outcomes = iter(
            [
                ...
                EvaluationOutcome.same(
                    "YES"
                ),  # Queued: FN (should have been clustered)
            ]
        )
    ...
    def test_f1_calculation(self):
        ...
        outcomes = iter(
            [
                ...
                EvaluationOutcome.same(
                    "YES"
                ),  # FN 1 (queued - should have been clustered)
            ]
        )
    ...
    def test_recall_with_zero_false_negatives(self):
        ...
        outcomes = iter(
            [
                ...
                EvaluationOutcome.different(
                    "NO"
                ),  # Queued: TN (correctly not clustered)
            ]
        )
    ...
    def test_metrics_with_known_false_positive_example(self):
        ...
        auto_sample = [
            {
                "emp1_name": "GRAHAM CAPITAL MANAGEMENT",
                "emp1_city": "NY",
                "emp1_state": "NY",
