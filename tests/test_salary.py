...
class TestCaseStatusParsing(unittest.TestCase):
    ...
    def test_parse_certified_withdrawn(self):
        self.assertEqual(CaseStatus.from_dol_value('Certified-Withdrawn'), CaseStatus.CERTIFIED_WITHDRAWN)
        self.assertEqual(CaseStatus.from_dol_value('CERTIFIED_WITHDRAWN'), CaseStatus.CERTIFIED_WITHDRAWN)
...
class TestEmployerNormalization(unittest.TestCase):
    ...
    def test_normalize_removes_common_words(self):
        ...
        self.assertEqual(Employer.normalize_name('The Microsoft Corporation'), 'microsoft')
    ...
    def test_normalize_handles_abbreviations(self):
        ...
        self.assertEqual(Employer.normalize_name('Johnson & Johnson'), 'johnson and johnson')
    ...
    def test_normalize_removes_punctuation(self):
        ...
        self.assertEqual(Employer.normalize_name('JPMorgan Chase & Co.'), 'jpmorgan chase and')
    ...
    def test_normalize_plural_to_singular_conversion(self):
        ...
        self.assertEqual(Employer.normalize_name('Echo IT Solutions Inc'), 'echo it solution')
        self.assertEqual(Employer.normalize_name('ECHO IT SOLUTION INC'), 'echo it solution')
        ...
        for plural_word, expected_singular in test_cases:
            ...
            self.assertIn(expected_singular, normalized,
        ...
        for exception_word in exceptions:
            ...
            self.assertIsNotNone(normalized, f"'{exception_word}' should normalize to something")
        ...
        for plural_name, singular_name in company_variations:
            ...
            self.assertEqual(norm_plural, norm_singular,
    ...
    def test_location_filtering_only_for_truly_generic_names(self):
        ...
        self.assertIn("hospital", norm1, f"Expected 'hospital' in normalized name: '{norm1}'")
        ...
        self.assertIn("hospital", norm1.lower(),
        ...
        self.assertIn("school", norm_schools.lower(),
            f"'SCHOOLS' should normalize to contain 'school' (singular), got: '{norm_schools}'")
        self.assertIn("center", norm_centers.lower(),
...
class TestSalaryRecordAnnualWage(unittest.TestCase):
    ...
    def test_annual_wage_from_yearly(self):
        ...
        record.calculate_annual_wage = SalaryRecord.calculate_annual_wage.__get__(record, SalaryRecord)
...
class TestWageValidation(unittest.TestCase):
    ...
    def test_validate_with_row_number(self):
        ...
        with self.assertLogs('lib.parsing.salary.wage_unit_correction', level='WARNING') as log:
