...
**Setup:** the `vb_redis` container provides Redis; `deployment/docker-compose.yml` includes the Redis service and sets `REDIS_URL=redis://redis:6379/1` for the web container.
